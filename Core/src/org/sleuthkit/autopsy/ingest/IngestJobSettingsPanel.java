...
public final class IngestJobSettingsPanel extends javax.swing.JPanel {
    ...
    public IngestJobSettings getSettings() {
        ...
        this.settings.setIngestFileFilter(fileFilter);
    ...
    private void initComponents() {
        ...
        filterButton.setText(org.openide.util.NbBundle.getMessage(IngestJobSettingsPanel.class, "IngestJobSettingsPanel.filterButton.text")); // NOI18N
